      ...
      >
        ...
        <div className="p-4 border-b border-slate-200 bg-slate-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="relative w-11 h-11 rounded-2xl bg-white border border-slate-200 p-1 shadow-sm shrink-0 flex items-center justify-center">
                <img
              ...
              <div className="overflow-hidden">
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span className="text-sm font-black text-slate-900 tracking-wider uppercase truncate">
                    IMAUR Rosario
                  </span>
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6 scrollbar-thin">
          ...
          <div className="space-y-1">
            <div className="px-3 pb-1.5 text-[10px] font-black tracking-widest text-slate-400 uppercase">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 font-mono">({totalSectores})</span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 font-mono">({totalPersonal})</span>
            </button>
          </div>

          {/* Section 3: Supervisión Operativa */}
          <div className="space-y-1">
            <div className="px-3 pb-1.5 text-[10px] font-black tracking-widest text-slate-400 uppercase flex items-center justify-between">
              <span>SUPERVISIÓN OPERATIVA</span>
              <span className="text-[8px] bg-slate-100 text-slate-600 px-1 py-0.5 rounded font-bold">Restringido</span>
            </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 text-xs font-bold transition group cursor-pointer shadow-sm"
            >
              <div className="flex items-center gap-2">
                <Printer className="w-4 h-4 text-emerald-700 group-hover:scale-110 transition-transform" />
                <span>Terminal de Taquilla</span>
              </div>
              <span className="text-[9px] bg-emerald-700 text-white px-1.5 py-0.5 rounded uppercase font-bold">
                Caja
              </span>
            </button>
          </div>
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50 space-y-3">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-emerald-100 border border-emerald-200 flex items-center justify-center text-emerald-800 font-black text-sm">
              {userName.charAt(0).toUpperCase()}
            </div>
            <div className="overflow-hidden flex-1">
              <div className="text-xs font-bold text-slate-900 truncate">{userName}</div>
              <div className="text-[10px] text-emerald-700 font-bold truncate flex items-center gap-1">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-3 bg-red-50 hover:bg-red-100 border border-red-200 text-red-700 rounded-xl text-xs font-bold transition cursor-pointer"
          >
